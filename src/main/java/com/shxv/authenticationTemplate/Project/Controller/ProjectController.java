package com.shxv.authenticationTemplate.Project.Controller;
...
import com.shxv.authenticationTemplate.Project.Service.ProjectService;
...
public class ProjectController {
    ...
    @Operation(
            ...
            description = "Deletes a project if the authenticated user is authorized to do so"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    public Mono<ResponseEnvelope<ProjectResponse>> deleteProject(
            @Parameter(
        ...
        return projectService.deleteProject(id)
                .map(deletedProject -> ResponseEnvelope.<ProjectResponse>builder()
                        .success(true)
                        .status(200)
